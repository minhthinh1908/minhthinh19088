      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="https://twitter.com" className="hover:text-blue-400 transition" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-blue-300 transition" aria-label="LinkedIn">
