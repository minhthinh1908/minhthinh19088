    ...
    return (
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <h1 className='text-4xl md:text-5xl font-bold leading-tight mb-4'>
            Explore Opportunities <br /> Với <span className='text-yellow-300'>Dream Job</span>
          </h1>
          ...
          <div className='flex flex-col md:flex-row items-center gap-4'>
            ...
            <Button
              ...
              className="w-full md:w-auto px-6 py-3 bg-yellow-400 hover:bg-yellow-300 text-black font-semibold rounded-lg shadow-lg"
            >
